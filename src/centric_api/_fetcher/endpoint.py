...
from .integrity import is_acceptable_count_drift
...
def run_endpoint(
    ...
    _emit_progress(
        ...
        FetchProgressEvent(
            ...
            endpoint=spec.name,
            delta_floor=effective_delta_floor,
            delta_floor_reason=delta_floor_reason if effective_delta_floor is None else None,
